    ...
    <section>
      ...
      <Card style={{ border: "none" }}>
        ...
        >
          ...
          <Card.Text>
            ...
            third-party API, Barcode Lookup, to scan items and manage in-person
            shopping cart. App allows users to change item quanities, set
            budgets, and view cart to budget ratio in live visualization. Built
            in 5 days after collaborative handoff with UX Designer.
          </Card.Text>
      ...
      <Card style={{ border: "none" }}>
        ...
        >
          ...
          <Card.Text>
            Full stack application built in 2-day sprint using MongoDB, express,
            and deployed on Heroku. Users can add their favorite cookbooks and
            authors to a public forum on frontend React.Js platform.{" "}
          </Card.Text>
          <a
          ...
          <a href="https://github.com/rneyrinck/CookBookerAPI" target="_blank">
            <Button variant="secondary">
              Repo Backend
              <BsArrowRight id="navbar-dropdown-arrows" />
            </Button>
      ...
      <Card style={{ border: "none" }}>
        ...
        >
          ...
          <Card.Text>
            ...
            users to create marketplace listings and communicate with comments.{" "}
          </Card.Text>
          <a
